        ...
        <v-card-title>
            <v-row align="center" class="w-100">
                ...
                <v-col cols="12" md="4" class="d-flex align-center">
                    ...
                    <span class="text-h6">Prioridad</span>
                </v-col>
...
const headers = [
    ...
    { title: 'Horas de SLA', key: 'sla_hours', width: '120px' },
    { title: 'Color', key: 'color', width: '100px', align: 'center' as const },
